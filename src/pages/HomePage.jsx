    ...
    <Box>
      ...
      <div className="conteiner1">
        ...
        <div style={{ display: "flex" }}>
          ...
          >
            ...
            >
              ОТКРОЙТЕ ДЛЯ СУБЯ ДОСТУПНЫЕ БИЛЕТЫ
            </h2>
            <Button
              style={{
                color: "white",
      ...
      <div style={{ marginTop: "130px" }}>
        ...
        <p style={{ margin: "10px", fontSize: "25px" }}>
          ...
          сомнение относительно их наличия. отправитель электронного письма.
          Если у вас есть какие-либо сомнения относительно подлинности
          сообщения, отправленного «Париж 2024» в связи с продажей билетов на
          Игры, мы приглашаем вас связаться с командой «Париж 2024» по
          следующему адресу: целостностьandenforcement@paris2024.org
        </p>
      </div>
    </Box>
  );
